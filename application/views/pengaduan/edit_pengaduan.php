                ...
                <div class="card-body">
                    <form action="<?= base_url('pengaduan/editPengaduan/' . $pengaduan['id_pengaduan']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="cursor: not-allowed;" disabled id="isi_laporan" class="form-control" name="isi_laporan" required><?= (form_error('isi_laporan')) ? set_value('isi_laporan') : $pengaduan['isi_laporan']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select style="cursor: not-allowed;" disabled id="id_masyarakat" class="custom-select" name="id_masyarakat">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select <?= (form_error('id_dusun')) ? 'is-invalid' : ''; ?>" id="id_dusun" name="id_dusun">
                                ...
                                ?>
                                <option value="<?= $d['id_dusun']; ?>" <?= $selected; ?>><?= htmlspecialchars($d['nama_dusun']); ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="invalid-feedback">
                                <?= form_error('id_dusun'); ?>
