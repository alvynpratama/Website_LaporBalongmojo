                    ...
                    <div class="form-group">
                        ...
                        <select id="id_masyarakat" class="custom-select <?= (form_error('id_masyarakat')) ? 'is-invalid' : ''; ?>" name="id_masyarakat">
                            ...
                            <?php foreach ($masyarakat as $dm): ?>
                                <?php $selected = (set_value('id_masyarakat') == $dm['id_masyarakat']) ? 'selected' : ''; ?>
                                <option value="<?= $dm['id_masyarakat']; ?>" <?= $selected; ?>><?= ucwords(strtolower($dm['username'])); ?></option>
                            <?php endforeach ?>
                        </select>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select <?= (form_error('id_dusun')) ? 'is-invalid' : ''; ?>" id="id_dusun" name="id_dusun">
                            ...
                            <?php foreach ($dusun as $d): ?>
                                <?php $selected = (set_value('id_dusun') == $d['id_dusun']) ? 'selected' : ''; ?>
