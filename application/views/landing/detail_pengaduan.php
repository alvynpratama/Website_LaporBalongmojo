...
<main class="flex-shrink-0">
    <div class="container mb-5">
            ...
            <div class="col-lg">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="width: 3rem" class="align-middle text-center">:</td>
                        <td class="align-middle"><?= $pengaduan['nama_dusun']; ?></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="row my-2">
            <div class="col-3">
                <div class="text-center bg-info py-3 rounded text-white">
        ...
        <div class="row my-3">
            <div class="col">
                ...
                <?php elseif ($pengaduan['status_pengaduan'] == 'proses'): ?>
                    <div class="progress">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="15"></div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <?php if ($dt['status_tanggapan'] == 'proses'): ?>
                                            <button type="button" class="btn btn-sm text-center btn-info"><i class="fas fa-fw fa-sync"></i> <?= $status; ?></button>
