<?php 
    ...
    // PERUBAHAN DI SINI: Query diubah untuk JOIN ke tabel dusun
    $this->db->select('*, pengaduan.id_pengaduan AS id_pengaduan, dusun.nama_dusun');
...
<head>
    ...
    <style>
        ...
        .btn-success {
          color: #fff;
          /* PERUBAHAN: Warna diubah ke hijau logo Anda */
